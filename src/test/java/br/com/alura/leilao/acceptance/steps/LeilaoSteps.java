...
public class LeilaoSteps {
	...
	public void preenche_o_formulario_com_dados_validos() {
		this.leiloesPage =  this.novaLeilaoPage.preencheForm("Computador", "1400", "12/07/2021");
	...
	public void o_novo_leilao_aparece_na_tabela() {
		Assert.assertTrue(this.leiloesPage.existe("Computador", "1400", "fulano", "12/07/2021"));
		this.browser.clean();
	}
